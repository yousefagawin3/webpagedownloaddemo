...
//        LogUtil.d(TAG, "Attempting to get thumbnail");
        if (!isMediaUri(uri)) {
...
//                LogUtil.e(TAG, "getThumbnail", e);
    ...
    fun isImageFile(filePath: String): Boolean {
        return if (filePath.endsWith(".jpg") || filePath.endsWith(".png") ||
    ...
    //checks if the filetype is video
